...
<body>
 ...
 <h1>Force.com Migration Tool</h1>
    <p>This is the Spring '20 version of the Force.com Migration Tool. The Force.com Migration Tool is a Java/Ant-based command-line utility for moving metadata between a local directory and
...
<dd>Optional. Defaults to 48.0. The API version to use for the retrieved metadata files.</dd>
...
<dd>Optional. Defaults to 48.0. Returns information about the metadata components available in the API version specified.</dd>
...
<dt><b>apiVersion</b></dt>
<dd>Optional. Defaults to 48.0. Describes only the metadata components available in the API version specified.</dd>
